...
const IOQuestion: React.FC<InputOutputFieldsProps> = ({ placeholder }) => {
  ...
  const handleSubmit = async () => {
    ...
    const response = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: `You are a professional question generator. You should generate 5 questions depending on the given text so that it looks perfect and relatable`,
        },
        { role: "system", content: `` },
