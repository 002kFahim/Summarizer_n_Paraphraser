...
const IOParaphrase: React.FC<InputOutputFieldsProps> = ({ placeholder }) => {
  ...
  const handleSubmit = async () => {
    ...
    const response = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: `You are a professional paraphraser. You should paraphrase the text so that it looks perfect, brief and easy to understand`,
        },
        { role: "system", content: `` },
